...
# Generated by qmake (2.01a) (Qt 4.7.3) on: Do 13. Okt 20:27:11 2011
# Project:  qmobilempdqtquick.pro
# Template: app
# Command: c:\qtsdk\symbian\sdks\symbian3qt473\bin\qmake.exe -spec ..\..\..\QtSDK\Symbian\SDKs\Symbian3Qt473\mkspecs\symbian-sbsv2 CONFIG+=release -after  OBJECTS_DIR=obj MOC_DIR=moc UI_DIR=ui RCC_DIR=rcc OBJECTS_DIR=obj MOC_DIR=moc UI_DIR=ui RCC_DIR=rcc -o bld.inf qmobilempdqtquick.pro
#############################################################################
...
qmake:
	$(QMAKE) "C:/qmobilempd/branches/qmobilempd-qtquick/qmobilempdqtquick.pro"  -spec ..\..\..\QtSDK\Symbian\SDKs\Symbian3Qt473\mkspecs\symbian-sbsv2 CONFIG+=release -after  OBJECTS_DIR=obj MOC_DIR=moc UI_DIR=ui RCC_DIR=rcc OBJECTS_DIR=obj MOC_DIR=moc UI_DIR=ui RCC_DIR=rcc
...
moc\moc_mediakeysobserver.cpp: mediakeysobserver.h
	C:\QtSDK\Symbian\SDKs\Symbian3Qt473\bin\moc.exe $(DEFINES) $(INCPATH) -DSYMBIAN c:\qmobilempd\branches\qmobilempd-qtquick\mediakeysobserver.h -o c:\qmobilempd\branches\qmobilempd-qtquick\moc\moc_mediakeysobserver.cpp

...
# Generated by qmake (2.01a) (Qt 4.7.4) on: Mo 21. Nov 18:44:56 2011
...
dodistclean:
	...
	-@ if EXIST "d:\QtSDK\Symbian\SDKs\Symbian3Qt474\epoc32\tools\makefile_templates\qt\distribution.policy.s60" $(DEL_FILE)  "d:\QtSDK\Symbian\SDKs\Symbian3Qt474\epoc32\tools\makefile_templates\qt\distribution.policy.s60"
	-@ if EXIST "d:\QtSDK\Symbian\SDKs\Symbian3Qt474\epoc32\tools\makefile_templates\qt\qmake_clean.flm" $(DEL_FILE)  "d:\QtSDK\Symbian\SDKs\Symbian3Qt474\epoc32\tools\makefile_templates\qt\qmake_clean.flm"
	-@ if EXIST "d:\QtSDK\Symbian\SDKs\Symbian3Qt474\epoc32\tools\makefile_templates\qt\qmake_emulator_deployment.flm" $(DEL_FILE)  "d:\QtSDK\Symbian\SDKs\Symbian3Qt474\epoc32\tools\makefile_templates\qt\qmake_emulator_deployment.flm"
	-@ if EXIST "d:\QtSDK\Symbian\SDKs\Symbian3Qt474\epoc32\tools\makefile_templates\qt\qmake_extra_pre_targetdep.flm" $(DEL_FILE)  "d:\QtSDK\Symbian\SDKs\Symbian3Qt474\epoc32\tools\makefile_templates\qt\qmake_extra_pre_targetdep.flm"
	-@ if EXIST "d:\QtSDK\Symbian\SDKs\Symbian3Qt474\epoc32\tools\makefile_templates\qt\qmake_post_link.flm" $(DEL_FILE)  "d:\QtSDK\Symbian\SDKs\Symbian3Qt474\epoc32\tools\makefile_templates\qt\qmake_post_link.flm"
	-@ if EXIST "d:\QtSDK\Symbian\SDKs\Symbian3Qt474\epoc32\tools\makefile_templates\qt\qmake_store_build.flm" $(DEL_FILE)  "d:\QtSDK\Symbian\SDKs\Symbian3Qt474\epoc32\tools\makefile_templates\qt\qmake_store_build.flm"
	-@ if EXIST "d:\QtSDK\Symbian\SDKs\Symbian3Qt474\epoc32\tools\makefile_templates\qt\qt.xml" $(DEL_FILE)  "d:\QtSDK\Symbian\SDKs\Symbian3Qt474\epoc32\tools\makefile_templates\qt\qt.xml"
